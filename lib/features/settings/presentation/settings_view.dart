...
class _SettingsViewState extends ConsumerState<SettingsView> {
  ...
  void initState() {
    ...
    final currentHours = ref.read(dailyWorkingHoursProvider).value ?? 8.0;
    _workingHoursController = TextEditingController(text: currentHours.toStringAsFixed(1));
  }
  ...
  Future<void> _saveSettings() async {
    if (_formKey.currentState!.validate()) {
      ...
      final newHours = double.parse(_workingHoursController.text);
      ...
      await updateDailyWorkingHours(ref, newHours);
    }
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        keyboardType: const TextInputType.numberWithOptions(decimal: true),
                        decoration: InputDecoration(
                          prefixIcon: const Icon(Icons.access_time, color: Color(0xFFF59E0B)),
                          hintText: '8.0',
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          ),
                        ...
                        validator: (value) {
                          if (value == null || value.trim().isEmpty) {
                            return 'Please enter working hours per day';
                          }
                          final parsed = double.tryParse(value);

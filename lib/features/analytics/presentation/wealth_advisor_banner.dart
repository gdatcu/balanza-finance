          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (nudge.targetTransaction != null) ...[
                  ...
                  OutlinedButton.icon(
                    onPressed: () {
                      showModalBottomSheet(
                        ...
                        builder: (_) => TransactionInputSheet(transactionToEdit: nudge.targetTransaction),
                      );
                    },
                    icon: const Icon(Icons.edit, size: 14),
                    label: Text(
                      nudge.getLocalizedActionLabel(currentLocale.languageCode) ?? 'Categorize Now',
